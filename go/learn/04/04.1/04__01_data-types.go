...
func main() {
	// unsafe circumvet type system and extraces memory size info for declared variables
	// program prints out the amount of memory consumed by each declared var
