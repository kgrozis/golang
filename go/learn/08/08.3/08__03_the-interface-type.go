...
// def: interface type:
//   set of methods that serves as a template to describe behavior
//   a type specified by the interface{} literal used to list a set of methods
// implementing an interface:
//   done implicitly, no element or keyword requeired to indicate teh intent of implementation
